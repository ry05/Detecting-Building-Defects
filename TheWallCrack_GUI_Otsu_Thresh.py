    ...
    def __init__(self, parent, controller):
        ...
        def crack_detector():
            ...
            try:
                ...
                print("Directory " , crack_highlight_dir ,  " Created ") 
            except FileExistsError:
                print("Directory " , crack_highlight_dir ,  " already exists")
            ...
            try:
                ...
                print("Directory " , major_crack_dir ,  " already exists")
            ...
            try:
                for item in dirs:
                    ...
                    if(os.path.isfile(full_path)):
                        ...
                        thresholded, highlight, major_crack, major_crack_area = image_derivatives(img)
            ...
            data = {"Image Name":image_names, "Crack Area":crack_areas, "White/Black Pixel Ratio":white_by_black_ratios,
                    "Class":image_class}
            df = pd.DataFrame(data)
            # Create a Pandas Excel writer using XlsxWriter as the engine.
            writer = pd.ExcelWriter(self.folder+'/'+'Test_output.xlsx', engine='xlsxwriter')
